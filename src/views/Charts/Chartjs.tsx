...
import { Line, PolarArea, Bar, Pie, Radar, Bubble } from "react-chartjs-2";
ChartJS.register(
  RadialLinearScale,
  CategoryScale,
  LinearScale,
  ...
  return (
    <main className="bg-gray-100 p-4 min-h-screen grid grid-cols-1 gap-4 lg:grid-cols-2">
      ...
      <div className="bg-white p-4 rounded shadow">
        <p>Line Chart</p>
        <div className="mt-2">
          <Line options={lineOptions} data={lineData} className="h-80" />
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded shadow">
        <p>Pie Chart</p>
        <div className="mt-2">
          <Pie data={pieData} options={pieOptions} className="h-80" />
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded shadow">
        <p>Radar Chart</p>
        <div className="mt-2">
          <Radar data={radarData} options={radarOptions} className="h-80" />
        </div>
      </div>
      ...
      <div className="bg-white p-4 rounded shadow">
        <p>Bubble Chart</p>
        <div className="mt-2">
          <Bubble options={bubbleOptions} data={bubbleData} className="h-80" />
        </div>
      </div>
